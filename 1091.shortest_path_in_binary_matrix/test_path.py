...
def test_shortest_path():
    ...
    print("[PASS] Test 1 passed: Example 1 - 2x2 grid")
    ...
    print("[PASS] Test 2 passed: Example 2 - 3x3 grid with path")
    ...
    print("[PASS] Test 3 passed: Example 3 - starting cell blocked")
    ...
    print("[PASS] Test 4 passed: Direct diagonal path")
    ...
    print("[PASS] Test 5 passed: Ending cell blocked")
    ...
    print("[PASS] Test 9 passed: Longer path with obstacles")
