...
def test_car_pooling():
    ...
    print("[PASS] Test 11 passed: Long distance trips with overlaps")
    ...
    print("[PASS] Test 12 passed: Exact capacity never exceeded")
